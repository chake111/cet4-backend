-- ============================================================
-- 2025�?月大学英语四级真题第1�?种子数据
-- 生成时间�?025-06-01
-- 包含：Writing(1�? + Listening(25�? + Reading_C(10�? + Translation(1�?
--       + Reading_A(10�? + Reading_B(10�?
-- 合计�?7 道题
-- ============================================================
...
VALUES ('2025�?月大学英语四级真题第1�?, 2025, 6, 1, 130, 710, 1);
...
-- ============================================================
-- Step 2.5: Part II Listening Comprehension（听力题，第1~25题）
-- 整段听力音频：所有听力题共用同一�?audio_url
-- Section A: News Reports (Questions 1-7)
-- Section B: Long Conversations (Questions 8-15)
-- Section C: Short Passages (Questions 16-25)
-- ============================================================
...
INSERT INTO `question`
    (`exam_id`, `part`, `question_no`, `question_type`, `content`, `passage`,
     ...
     `correct_answer`, `score`, `audio_url`, `sort_order`)
VALUES
-- Section A: News Report 1 (Questions 1-2)
(
    @exam_id,
    'listening',
    1,
    ...
    'D',
    7,
    'https://cet4-audio.oss-cn-guangzhou.aliyuncs.com/audio/cet4/2025/06/set1/2025%E5%B9%B46%E6%9C%88%E5%9B%9B%E7%BA%A7%E5%90%AC%E5%8A%9B-%E7%AC%AC1%E5%A5%97.mp3',
    100
),
(
    @exam_id,
...
-- Section A: News Report 2 (Questions 3-4)
(
    @exam_id,
    'listening',
    3,
...
-- Section A: News Report 3 (Questions 5-7)
(
    @exam_id,
    'listening',
    5,
...
-- Section B: Long Conversation 1 (Questions 8-11)
(
    @exam_id,
    'listening',
    8,
...
-- Section B: Long Conversation 2 (Questions 12-15)
(
    @exam_id,
    'listening',
    12,
...
-- Section C: Short Passage 1 (Questions 16-18)
(
    @exam_id,
    'listening',
    16,
...
-- Section C: Short Passage 2 (Questions 19-21)
(
    @exam_id,
    'listening',
    19,
...
-- Section C: Short Passage 3 (Questions 22-25)
(
    @exam_id,
    'listening',
    22,
...
-- Passage Two（第51~55题）
-- 文章：关于Angela Duckworth《坚毅》一书中"grit"概念的介�?
...
(
    ...
    56,
    'translation',
    '被誉�?杂交水稻(hybrid rice)之父"的袁隆平和他的科研团队克服重重困难，研发出了一种超级杂交水稻。这项技术获得了举世公认的巨大成功。通过这项技术的应用，水稻抗旱抗病能力更强，能适应不同的气候和土壤条件，产量可提高20-30%。超级杂交水稻营养丰富，口感更佳。目前，这项技术已经在许多国家得到广泛应用，为全球粮食安全做出了重大贡献�?,
    NULL,
    NULL, NULL, NULL, NULL,
    NULL,
    106,
...
--
-- 答案�?6-D(complex) 27-G(previously) 28-A(accepted) 29-E(constitutes)
...
-- ============================================================
-- 答案�?6-H 37-C 38-L 39-A 40-M 41-G 42-K 43-D 44-J 45-B
...
-- 插入统计�?
--   writing    : 1 �?
--   listening  : 25 题（�?~25题，Section A 7�?+ Section B 8�?+ Section C 10题）
--   reading_c  : 10 题（�?6~55题）
--   translation: 1 �?
--   reading_a  : 10 题（�?6~35题）
--   reading_b  : 10 题（�?6~45题）
--   合计       : 57 �?
-- ============================================================
